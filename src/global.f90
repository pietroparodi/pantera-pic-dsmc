...
MODULE global
   ...
   TYPE BOUNDARY_CONDITION_DATA_STRUCTURE
      ...
      REAL(KIND=8) :: DISPLACEMENT_CURRENT = 0.d0
      REAL(KIND=8) :: LAST_EDOTA = 0.d0
      REAL(KIND=8) :: EDOTA = 0.d0
   ...
   ENUM, BIND(C)  
      ENUMERATOR UNIFORM, THERMIONIC, THERMIONIC_ENHANCED, FIELD, EVAPORATION, PRESHEATH
   END ENUM
   ...
   REAL(KIND=8)               :: EXTERNAL_FIELD_FREQUENCY = 0.d0
   ...
   INTEGER      :: DUMP_RESTART_EVERY = 1
   INTEGER      :: DUMP_RESTART_START = 0
   ...
   INTEGER      :: LIMIT_PARTICLE_NUMBER = 0
   INTEGER      :: LIMIT_PARTICLE_EVERY = 1
   ...
   ENUM, BIND(C)
   ENUMERATOR NO_COLL, DSMC, BGK, MCC, MCC_VAHEDI, DSMC_VAHEDI, MCC_DSMC_VAHEDI
   END ENUM
   ...
   REAL(KIND=8), DIMENSION(:,:), ALLOCATABLE :: MCC_BG_CELL_NRHO, MCC_BG_CELL_TTR
   REAL(KIND=8), DIMENSION(:,:), ALLOCATABLE :: MCC_BG_CELL_VX, MCC_BG_CELL_VY, MCC_BG_CELL_VZ
   LOGICAL           :: BOOL_MCC_BG_FILE = .FALSE.
   ...
   TYPE CONNECTED_COND_SURFACE
      ...
      REAL(KIND=8), DIMENSION(:), ALLOCATABLE       :: TOTAL_CHARGE


      REAL(KIND=8) :: SUM_METAL_CHARGE, SUM_TOP_FACTOR, SUM_BOTTOM_FACTOR
   ...
   REAL(KIND=8), DIMENSION(:), ALLOCATABLE :: AVG_NREAL
   ...
   REAL(KIND=8) :: RF_GENERATOR_VOLTAGE = 1000.d0
   REAL(KIND=8) :: FIELD_POWER_TARGET = 20.d0/0.25 ! W/m
   INTEGER :: FIELD_POWER_START = 250
   INTEGER :: FIELD_POWER_EVERY = 2000
   INTEGER :: FIELD_POWER_NUMAVG = 1000
   REAL(KIND=8), DIMENSION(:), ALLOCATABLE :: FIELD_POWER_AVG

   REAL(KIND=8) :: ELEC_ENERGY
   REAL(KIND=8) :: ELEC_ENERGY_TOTAL
